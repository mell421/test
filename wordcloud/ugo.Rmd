...
pie(table(dfCommAll$ratingUser),label=paste(names(table(dfCommAll$ratingUser)),table(dfCommAll$ratingUser),sep="-"), edges=10)
title("distribution des notes utilisateur avec comm")
box()

pie(table(dfSsCommAll$ratingUser),label=paste(names(table(dfSsCommAll$ratingUser)),table(dfSsCommAll$ratingUser),sep="-"), edges=10)
title("distribution des notes utilisateur sans comm")
box()

pie(table(dfAll$ratingUser),label=paste(names(table(dfAll$ratingUser)),table(dfAll$ratingUser),sep="-"), edges=10)
