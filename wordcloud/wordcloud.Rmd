...
tm <- function(text){
  ...
  # Remove numbers : TextDoc <- tm_map(TextDoc, removeNumbers)
  # Remove english common stopwords : TextDoc <- tm_map(TextDoc, removeWords, stopwords("english"))
  ...
  # Eliminate spaces : TextDoc <- gsub("[[:blank:]]", "", TextDoc)
  # Text stemming : TextDoc <- tm_map(TextDoc, stemDocument)
