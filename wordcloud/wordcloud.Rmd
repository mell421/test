...
tm <- function(text){
  ...
  #dev.print(device = png, file = "accueil_2.png", width = 600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","accueil_3.png", delay =5, vwidth = 700, vheight=700)
...
tm <- function(text){
  ...
  #dev.print(device = png, file = "encours_2.png", width = 600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","encours_3.png", delay =5, vwidth = 700, vheight=700)
...
tm <- function(text){
  ...
  #dev.print(device = png, file = "recent_2.png", width = 600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","recent_3.png", delay =5, vwidth = 700, vheight=700)
...
tm <- function(text){
  ...
  # dev.print(device = png, file = "termine_2.png", width = 600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","termine_3.png", delay =5, vwidth = 700, vheight=700)
...
main <- function(){
  ...
  #dev.print(device = png, file = "copy_2.png", width=600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","copy_3.png", delay =5, vwidth = 700, vheight=700)
...
main <- function(){
  ...
  # Remove your own stop word
  # specify your custom stopwords as a character vector
  TextDoc <- tm_map(TextDoc, removeWords, c("conclu", "conclubis", "eff","the","sem","mois","premderall","last48tri","last46","offset3","nbPageTri","nbPage","nbTpsPc"))
  # Remove punctuations
  TextDoc <- tm_map(TextDoc, removePunctuation)
  # Eliminate extra white spaces
  TextDoc <- tm_map(TextDoc, stripWhitespace)
  ...
  #dev.print(device = png, file = "copy_2.png", width=600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","pageappres_3.png", delay =5, vwidth = 700, vheight=700)
...
main <- function(){
  ...
  #dev.print(device = png, file = "copy_2.png", width=600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","pageappressup_3.png", delay =5, vwidth = 700, vheight=700)
...
main <- function(){
  ...
  #dev.print(device = png, file = "conclu_2.png", width = 600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","conclu_3.png", delay =5, vwidth = 700, vheight=700)
...
main <- function(){
  ...
  #dev.print(device = png, file = "conclubis_2.png", width = 600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","conclubis_3.png", delay =5, vwidth = 700, vheight=700)
...
#dev.print(device = png, file = "sem_2.png", width = 600)
      ...
      my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","sem_3.png", delay =5, vwidth = 700, vheight=700)
...
main <- function(){
  ...
  #dev.print(device = png, file = "mois_2.png", width=600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","mois_3.png", delay =5, vwidth = 700, vheight=700)
...
main <- function(){
  ...
  #dev.print(device = png, file = "max_2.png", width = 600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","max_3.png", delay =5, vwidth = 700, vheight=700)
...
main <- function(){
  ...
  #dev.print(device = png, file = "eff_2.png", width = 600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","eff_3.png", delay =5, vwidth = 700, vheight=700)
...
main <- function(){
  ...
  #dev.print(device = png, file = "resume_2.png", width = 600)
    ...
    my_graph <- wordcloud2(data = dtm_d, color = "random-light",backgroundColor ="black")
    saveWidget(my_graph,"tmp.html",selfcontained = F)
    webshot("tmp.html","resume_3.png", delay =5, vwidth = 700, vheight=700)
