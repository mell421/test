...
```{r 2019, eval=FALSE, include=FALSE}
### 2019
text2 <- data.frame(aRew())
text <- text2[2]
main <- function(text){
  ...
  # Plot the most frequent words
  barplotSimple(dtm_d[1:20,]$freq,dtm_d[1:20,]$word,"Top 20 2019")
  

  #generate word cloud
  wcSimple(dtm_d$word,dtm_d$freq)
  wcDouble(dtm_d,forme,"rewind19_3.png",delayW)
}
...
```{r 2020, eval=FALSE, include=FALSE}
### 2020
text2 <- data.frame(aRew())
text <- text2[11]
main <- function(text){
  ...
  # Plot the most frequent words
  barplotSimple(dtm_d[1:20,]$freq,dtm_d[1:20,]$word,"Top 20 2020")
  

  #generate word cloud
  wcSimple(dtm_d$word,dtm_d$freq)
  wcDouble(dtm_d,forme,"rewind20_3.png",delayW)
}
...
```{r 2021, eval=FALSE, include=FALSE}
### 2021
text2 <- data.frame(aRew())
text <- text2[20]
main <- function(text){
  ...
  # Plot the most frequent words
  barplotSimple(dtm_d[1:20,]$freq,dtm_d[1:20,]$word,"Top 20 2021")
  

  #generate word cloud
  wcSimple(dtm_d$word,dtm_d$freq)
  wcDouble(dtm_d,forme,"rewind21_3.png",delayW)
}
...
main <- function(text){
  ...
  # Plot the most frequent words
  barplotSimple(dtm_d[1:20,]$freq,dtm_d[1:20,]$word,"Top 20 2022")
  

  #generate word cloud
  wcSimple(dtm_d$word,dtm_d$freq)
  wcDouble(dtm_d,forme,"rewind22_3.png",delayW)
}
