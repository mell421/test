...
### conclu-bis-eff
```{r conclubiseff, echo=FALSE}
text2 <- data.frame(aTestConcluAllEff())
text <- text2[2]
main <- function(text){
  ...
  # Plot the most frequent words
  barplotSimple(dtm_d[1:20,]$freq,dtm_d[1:20,]$word,"Top 20 conclu-bis-eff")
  

  #generate word cloud
  wcSimple(dtm_d$word,dtm_d$freq)
  wcDouble(dtm_d,forme,"conclubiseff_3.png",delayW)
}
...
<!-- copy 68 -->
### mois-sem
```{r moissem, echo=FALSE}
text2 <- data.frame(aTestMS())
text <- text2[2]
main <- function(text){
  ...
  # Plot the most frequent words
  barplotSimple(dtm_d[1:20,]$freq,dtm_d[1:20,]$word,"Top 20 mois-sem")
  

  #generate word cloud
  wcSimple(dtm_d$word,dtm_d$freq)
  wcDouble(dtm_d,forme,"moissem_3.png",delayW)
